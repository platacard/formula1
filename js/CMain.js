function CMain(oData) {
  ...
  this._loadImages = function () {
    ...
    for (var i = 0; i < NUM_WORLDS; i++) {
      s_oSpriteLibrary.addSprite(
        "w" + i + "_patch",
        "./sprites/backgrounds/world_" + i + "/patch.png",
      );
      s_oSpriteLibrary.addSprite(
        "w" + i + "_bg0",
        "./sprites/backgrounds/world_" + i + "/bg0.webp",
      );
      s_oSpriteLibrary.addSprite(
        "w" + i + "_bg1",
        "./sprites/backgrounds/world_" + i + "/bg1.webp",
      );
      s_oSpriteLibrary.addSprite(
        "w" + i + "_bg2",
        "./sprites/backgrounds/world_" + i + "/bg2.webp",
      );
    }
    ...
    for (var i = 0; i < 30; i++) {
      s_oSpriteLibrary.addSprite(
        "hit_contact_" + i,
        "./sprites/hit_contact/hit_contact_" + i + ".png",
      );
    }
    ...
    for (var i = 0; i < 5; i++) {
      s_oSpriteLibrary.addSprite(
        "billboard_" + i,
        "./sprites/elements/day/billboard_" + i + ".png",
      );
      s_oSpriteLibrary.addSprite(
        "billboard_arc_" + i,
        "./sprites/elements/day/billboard_arc_" + i + ".png",
      );
    }
    s_oSpriteLibrary.addSprite(
      "billboard_" + 5,
      "./sprites/elements/day/billboard_" + 5 + ".png",
    );

    s_oSpriteLibrary.addSprite("finish", "./sprites/elements/day/finish.png");
    s_oSpriteLibrary.addSprite(
      "security_wall",
      "./sprites/elements/day/security_wall.png",
    );
    ...
    for (var i = 0; i < 5; i++) {
      s_oSpriteLibrary.addSprite(
        "car_shadow_" + i,
        "./sprites/cars/car_shadow/car_shadow_" + i + ".png",
      );
    }
