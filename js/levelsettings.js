...
ROAD_INFO[0] = [
  ...
  { roadtype: ROAD.TYPE.FINAL, length: ROAD.LENGTH.SHORT - 12 },
];
LEVEL_INFO[0] = {
  time: 70000,
  num_cars: 0,
...
AMBIENT_INFO[0] = [
  {
    type: AMBIENT.TYPE.FILL_TRACK,
    sprite: SPRITES.SECURITY_WALL,
    position: 8,
    repetitionevery: 10,
  ...
  {
    side: AMBIENT.SIDE.CENTER,
    sprite: SPRITES.BILLBOARD_ARC_4,
    position: 0,
    segments: [850, 1250],
    repetitionevery: 40,
    disposition: AMBIENT.DISPOSITION.PRECISE,
  ...
  {
    side: AMBIENT.SIDE.CENTER,
    sprite: SPRITES.BILLBOARD_ARC_0,
    position: 0,
    segments: [2400, 2400],
    repetitionevery: 50,
    disposition: AMBIENT.DISPOSITION.PRECISE,
  ...
  {
    side: AMBIENT.SIDE.CENTER,
    sprite: SPRITES.BILLBOARD_ARC_2,
    position: 0,
    segments: [5950, 7250],
    repetitionevery: 100,
    disposition: AMBIENT.DISPOSITION.PRECISE,
  ...
  {
    side: AMBIENT.SIDE.CENTER,
    sprite: SPRITES.BILLBOARD_ARC_3,
    position: 0,
    segments: [6000, 7200],
    repetitionevery: 100,
    disposition: AMBIENT.DISPOSITION.PRECISE,
...
LEVEL_INFO[2] = {
  ...
  num_cars: 0,
  num_laps: 2,
  minimap: { x: 0, y: 0, scale: 0.6, rot: 0 },
  terrain: {
    roadbounds: 2,
    num_lanes: 1,
    adherence: 1,
...
AMBIENT_INFO[2] = [
  ...
  {
    side: AMBIENT.SIDE.CENTER,
    sprite: SPRITES.BILLBOARD_ARC_1,
    position: 0,
    segments: [200, 750],
    repetitionevery: 30,
    disposition: AMBIENT.DISPOSITION.PRECISE,
