function CGfxButton(iXPos, iYPos, oSprite, oParentContainer, scale = 1) {
  var _bDisabled;
  var _bScalable;
  ...
  this._init = function (iXPos, iYPos, oSprite, oParentContainer, scale) {
    _bDisabled = false;
    _bScalable = true;
  ...
  this.pulseAnimation = function () {
    _oTween = createjs.Tween.get(_oButton, { loop: true })
      .to(
        { scaleX: _iScaleFactor * 1.1, scaleY: _iScaleFactor * 1.1 },
        850,
        createjs.Ease.quadOut
      )
      .to(
        { scaleX: _iScaleFactor, scaleY: _iScaleFactor },
        650,
  ...
  _oParent = this;
  this._init(iXPos, iYPos, oSprite, oParentContainer, scale);
